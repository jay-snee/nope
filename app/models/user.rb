class User < ApplicationRecord
  ...
  def after_confirmation
    Processing::EventJob.perform_later("new user confirmed - #{id}", 'sign up', true)
  end
  ...
  def cancel_stripe_subscription
    ...
    Processing::EventJob.perform_later("subscripton cancelled - #{id}", 'subscription', true)
  end

  def notify_registration
    Processing::EventJob.perform_later("new user registration - #{id}", 'sign up', true)
  end
