...
(function() {
  App.cable.subscriptions.create({
    channel: "ApplicationCable::MessagesChannel",
    id: $('#message-list').data('id')
  }, {
    received: function(data) {
      ...
      return $.growl.notice({
        title: "New Message!",
        message: "New message has arrived"
      });
    },
    prependLine: function(data) {
      ...
      if ($('#messages-list').data('profile') === data.profile_id || $('#messages-list').data('profile') === '*') {
